...
def modified_GPTNeoX_attention_forward(
    ...
    q_rot = apply_rotary_pos_emb_single(q_rot, cos_gpu, sin_gpu, position_ids)
    ...
    if k_cache_cpu is not None:
        ...
        v_gpu,s_gpu = mha_logSum(q,k_cache_gpu,v_cache_gpu,attention_mask_q)
...
def modify_GPTNeoX_attention(model,KVCache_manager):
    ...
    rotary_emb_cpu = GPTNeoXRotaryEmbedding(head_dim,device='cpu')
