...
if __name__ == '__main__':
    ...
    for i,q_len in enumerate([1,32]):
            ...
            axs[0].set_ylabel('Achieved Attention FLOPs', fontsize=18)
    ...
    fig.legend(handles, labels,frameon=False, loc='upper center', ncol=3, bbox_to_anchor=(0.55, 1.2) , fontsize=16)

    fig.text(0.55, 0.04, 'KV Cache Length' , ha='center', va='center' , fontsize=18)  # Common y label , fontsize=16
