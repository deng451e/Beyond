...
for prompt_len in  1920 #  500 600
    ...
    do  
        ...
        do
            ...
            cmd=$cmd_" --overlap false --start_size 10 --recent_size 2000"
            outpt="==================================================================================="$'\n'
            ...
            cmd=$cmd_"  --alpha 4 --partial-weight-ratio 0.2 --max-num-kv 409 --overlap false"
            outpt="==================================================================================="$'\n'
            ...
            # cmd=$cmd_" --overlap false  --max-num-kv 409 --hh-ratio 0.1 --hh-all"
            # outpt="==================================================================================="$'\n'
